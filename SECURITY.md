...
For `generator-white-label`, pay particular attention to generated dependency/configuration safety, template escaping, build-time path handling, generated HTML injection boundaries, and any changes that affect deployment metadata or client-side code.